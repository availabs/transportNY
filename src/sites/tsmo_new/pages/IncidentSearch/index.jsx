...
//  console.log("This we reached!!!");
  ...
  const getEvents = async () => {
    ...
    const events = await falcor.get(["transcom2", "eventsbyGeom",TSMO_VIEW_ID, JSON.stringify(request)]);
    eventIds = get(events, ["json", "transcom2", "eventsbyGeom", TSMO_VIEW_ID, JSON.stringify(request)], []) || [];
